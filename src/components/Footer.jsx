...
const Footer = () => {
  return (
    <footer className="absolute z-10 bottom-0 w-full px-2">
        <div className="flex justify-between px-4 py-4 mx-auto items-center">
            <p className="flex mr-2 items-center"><SiGoogleearth style={{ marginRight: '8px' }} className="text-5xl"/> UTCC 3D Diagram</p>
